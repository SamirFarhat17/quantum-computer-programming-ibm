...
def visualize_solution(xc, yc, x, C, n, K, title_str, index):
    plt.figure()
    ...
    index += 1
    plt.savefig('vehicle_routing_cost'+str(index))
    #plt.show()

if x is not None:
    visualize_solution(xc, yc, x, classical_cost, n, K, 'Classical',10)
...
# visualize the solution
visualize_solution(xc, yc, x_quantum, quantum_cost, n, K, 'Quantum',2)

# and visualize the classical for comparison
if x is not None:
    visualize_solution(xc, yc, x, classical_cost, n, K, 'Classical',3)